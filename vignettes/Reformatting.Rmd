...
The `All` keyword, in first layer, lower or Mixed case, can be used instead of a table name to
indicate that a particular variable should be changed in every table where it appears.
